...
<div class="flex">
 <div class="container offset-sm-4 col-sm-4">
    ...
    <div class="col-sm-2"><button type="submit" class="btn btn-primary" id="pseudoBtn">Valider</button></div>
  </div>
...
<div class="flex" style="align-items: center;">  
  <form onsubmit='return false;' class="my-2 my-lg-0 offset-sm-4 col-sm-4 formInscription">   
    <div class="form-group">
      ...
      <input type="email" id="inputEmail" class="form-control" name="inputEmail" aria-describedby="emailHelp" placeholder="Email" required value="<?php echo($_SESSION['id']) ?>" readonly>  
    </div>
    <div class="form-group">
